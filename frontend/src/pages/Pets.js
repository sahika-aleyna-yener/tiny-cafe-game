...
const PETS = [
  ...
  { pet_id: 'cat_orange', name_tr: 'Turuncu Kedi', name_en: 'Orange Cat', description_tr: 'Tembel ama sevimli', description_en: 'Lazy but cute', image: '/assets/pets/cat-orange.jpg', price: 100, unlock_level: 2 },
  { pet_id: 'bunny', name_tr: 'Beyaz Tavşan', name_en: 'White Bunny', description_tr: 'Hızlı ve zeki', description_en: 'Fast and smart', image: '/assets/pets/bunny-white.jpg', price: 150, unlock_level: 3 },
  { pet_id: 'puppy', name_tr: 'Kahverengi Köpek', name_en: 'Brown Puppy', description_tr: 'En sadık dost', description_en: 'Most loyal friend', image: '/assets/pets/puppy-brown.jpg', price: 200, unlock_level: 4 },
  ...
  { pet_id: 'kitten', name_tr: 'Gri Kedi', name_en: 'Gray Kitten', description_tr: 'Gizemli ve zarif', description_en: 'Mysterious and elegant', image: '/assets/pets/kitten-gray.jpg', price: 120, unlock_level: 2 },
